...
int trans_button(int x,int y)
{
	...
	tx=x-(screen_width-GUI_QSPELLS_XOFF);
	ty=y-(screen_height-GUI_QSPELLS_YOFF+48);
	for (n=0; n<4; n++) {
	...
	tx=x-(screen_width-GUI_QSPELLS_XOFF);
	ty=y-(screen_height-GUI_QSPELLS_YOFF+66);
	for (n=0; n<4; n++) {
		if (tx>=0 && tx<=41 && ty>=0 && ty<=14) {
			hightlight=HL_BUTTONBOX;
			hightlight_sub=n+4;
	...
	tx=x-(screen_width-GUI_QSPELLS_XOFF);
	ty=y-(screen_height-GUI_QSPELLS_YOFF+84);
	for (n=0; n<4; n++) {
		if (tx>=0 && tx<=41 && ty>=0 && ty<=14) {
			hightlight=HL_BUTTONBOX;
			hightlight_sub=n+8;
  	...
  	tx=x-(screen_width-GUI_QSPELLS_XOFF);
	ty=y-(screen_height-GUI_QSPELLS_YOFF);
	for (n=0; n<4; n++) {
		if (tx>=0 && tx<=41 && ty>=0 && ty<=14) {
			hightlight=HL_BUTTONBOX;
			hightlight_sub=n;
	...
	tx=x-(screen_width-GUI_QSPELLS_XOFF);
	ty=y-(screen_height-GUI_QSPELLS_YOFF+15);
	for (n=0; n<4; n++) {
		if (tx>=0 && tx<=41 && ty>=0 && ty<=14) {
			hightlight=HL_BUTTONBOX;
			hightlight_sub=n+4;
	...
	tx=x-(screen_width-GUI_QSPELLS_XOFF);
	ty=y-(screen_height-GUI_QSPELLS_YOFF+30);
	for (n=0; n<4; n++) {
		if (tx>=0 && tx<=41 && ty>=0 && ty<=14) {
			hightlight=HL_BUTTONBOX;
			hightlight_sub=n+8;
